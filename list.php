  ...
  <body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $sql = 'SELECT * FROM sites ORDER BY datetime, DESC';
            ...
            $result = $mysqli->query($sql);
                ...
                if ($result->num_rows > 0)
                {
                    while($row = $result->fetch_assoc())
                    {
                       ...
                       echo '<a href="https://sites4design.com/apps/cls/preview.php?site_id=' . $row['site_id'] . '" target="_blank">' . $row["title"] . ' (' . $row["theme"] . ' ' . $row["color"] . ' ' . $row["datetime"] . ' )</a><br />';
                    }
                }
                else
                {
